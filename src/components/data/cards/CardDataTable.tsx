...
const CardDataTable: React.FC<CardDataTableProps> = ({
  ...
  return (
    <section style={{ border: "1px solid #374151", borderRadius: "8px", overflow: "hidden", display: "grid", gridTemplateRows: selectedStatLabel || nameFilter.trim() ? "auto auto auto minmax(0, 1fr) auto" : "auto auto minmax(0, 1fr) auto", minHeight: 0 }}>
